    ...
    public void sendTarifa(String to1) {
        ...
        try {
            ...
            messageBodyPart1.setText("Geração de Fatura \n" +
                    "Pagamento requerido para finalização da transação \n " +
                    "Detalhes da fatura no corpo do anexo \n" +
                    "Atenciosamente Empresa4001");
            MimeBodyPart messageBodyPart2 = new MimeBodyPart();
            String fileName = "/data/data/com.example.hitman.tcc2/files/fatura.txt";//change accordingly
