...
import com.example.hitman.tcc2.views.Eletronicos;

public class BDEletro extends SQLiteOpenHelper {

    private static int version=1;
    private static String nomeBaseDados = "Eletro";
    private static CursorFactory factory = null;

    public BDEletro(Context context) {
    ...
    public  eletro[] recuperarDados() {
        ...
        lista = new eletro[c.getCount()];
        int i = 0;

        if (c.moveToFirst()) {
            do {
                eletro alimen = new eletro();
